"ffmpeg.exe" -i %1 -b:v 1000k -maxrate 1500k -bufsize 3000k -c:v libvpx -crf 5 -qmin 0 -qmax 50 -vf scale=640:-1 -acodec libvorbis -ab 48k -y -f webm -g 50 %~p1%~n1.webm
"ffmpeg.exe" -i %1 -b:v 1000k -maxrate 1500k -bufsize 3000k -vcodec libtheora -quality best -vf scale=640:-1 -acodec libvorbis -y -ab 48k %~p1%~n1.ogv
