...
var Main = new Class({
    ...
    initialize : function() {
        ...
        var _self = this;
        this.listOfLibraries = new Array("js/mylibs/createjs/soundjs-0.2.0.min.js", "js/mylibs/video-js/video.js", "js/mylibs/com/studywiz/core/VideoPlayer.js")
    ...
    _loadLibrary : function(item, index) {
        ...
        var loadJS = new Asset.javascript(item, {
            id : index,
            onLoad : function() {
               // alert(item);
