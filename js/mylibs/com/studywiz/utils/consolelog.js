...
if (!window.log) {
    window.log = function() {
        var args = arguments, isIECompatibilityView = false, i, sliced,
        ...
        isIE8 = function _isIE8() {
            ...
            return (!Function.prototype.bind || (Function.prototype.bind && typeof window.addEventListener === 'undefined')) && typeof console === 'object' && typeof console.log === 'object';
        };
        ...
        if (log.detailPrint && log.needsDetailPrint) {( function() {
