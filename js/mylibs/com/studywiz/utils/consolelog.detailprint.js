...
window.log.needsDetailPrint = ( function _log_needsDetailPrint() {
        var ua = window.navigator.userAgent, uaCheck, uaVersion;
...
window.log.detailPrint = function _log_detailPrint(args) {
    ...
    getSpecificType = function _getSpecificType(obj) {
        var reportedType = Object.prototype.toString.call(obj), types = ['Array', 'Date', 'RegExp', 'Null'], found = '', n;
        ...
        // Node list
        if (/^\[object (HTMLCollection|NodeList|Object)\]$/.test(reportedType) && typeof obj.length === 'number' && typeof obj.item !== 'undefined' && (obj.length === 0 || ( typeof obj[0] === 'object' && obj[0].nodeType > 0))) {
            found = 'node';
        }
